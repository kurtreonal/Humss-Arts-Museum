...
public class AMImageViewer extends javax.swing.JFrame {
    int count;
    public AMImageViewer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AMImageViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AMImageViewer().setVisible(true);
            }
        });
    }
